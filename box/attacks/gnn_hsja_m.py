...
from ..tools import ImageGraph, GCN, train
from dgl.nn.pytorch import GraphConv, GATConv, GCN2Conv


class GNN_HSJA_M(MinimizationAttack):
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        self.image_graph = ImageGraph(originals.shape[2], T=self.args.T)
        ...
        for step in range(self.steps):
            ...
            if self.constraint == "linf":
                ...
                if previous_gradients is not None:
                    update += mu * previous_gradients
            previous_gradients = update
    ...
    def approximate_gradients(
        ...
        if self.constraint == "l2":
            ...
            rv = self.graph_filter_generator(originals, x_advs, noise_shape)
