...
class GNN_HSJA(MinimizationAttack):
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        self.image_graph = ImageGraph(originals.shape[2], T=self.args.T, delta=self.args.delta)
    ...
    def approximate_gradients(
        ...
        if self.constraint == "l2":
            ...
            rv = self.ep_graph_filter_generator(originals, x_advs, noise_shape)
